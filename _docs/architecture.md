...
| ----------- | ------- | ----------- | ------------------- | --------------------------------------- |
| Matriz LED  | C1–C8   | `PD0`–`PD7` | Salida push-pull    | Ánodos, **activas en alto**. Byte bajo del puerto |
| Matriz LED  | F1–F8   | `PE8`–`PE15` | Salida push-pull   | Cátodos, **activas en bajo**. Byte alto del puerto |
